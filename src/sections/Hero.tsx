...
export const Hero = () => {
  return (
    <section style={{ backgroundImage: `url(${starBg.src})` }} className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
      ...
      {/* end ring 1 */}
      {/* start ring 2 */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border border-white/20  border-dashed rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      {/* end ring 2 */}
      {/* start ring 3 */}
