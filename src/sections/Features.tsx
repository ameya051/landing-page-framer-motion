  ...
  return <section className="py-20 md:py-24">
    <div className="container">
      ...
      <div className="mt-10 flex flex-col lg:flex-row gap-3">
        {
          tabs.map((tab) => <div key={tab.title} className="border border-white/15 flex lg:flex-1 items-center p-2.5 rounded-xl gap-2.5">
            <div className="size-12 border border-white/15 rounded-lg inline-flex items-center justify-center">
              <DotLottiePlayer autoplay src={tab.icon} className="size-5" />
            </div>
      ...
      <div className="border border-white/20 p-2.5 rounded-xl mt-3">
        <div className="aspect-video bg-cover border border-white/20 rounded-lg" style={{ backgroundImage: `url(${productImg.src})` }}>
        </div>
